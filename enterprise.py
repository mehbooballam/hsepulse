...
SCHEMAS.update({'Projects':['id','name','client','location','lead','hse_lead','status','target','closed_at','closed_by','closure_notes','closure_context','deleted_at','deleted_by']+META,'Settings':['id','value']+META,'Standards':['id']+list(REF['standards'][0])+['Review Status']+META,'Evidence':['id','project','record_id','filename','mime','chunk','content']+META,'AlertState':['id','project','status','note']+META})
